...
<p align="center"><b>条形 TFT 模组 · MIPI DSI · GC9503CV</b></p>
...
<p align="center"><img alt="OSPTEK 3.13 寸 376×960 TFT MIPI 模组（GC9503CV）宣传图" src="./images/product.png" width="640" /></p>
...
OSPTEK **3.13 寸 376×960 TFT** 是一款 **MIPI** 接口彩色显示模组，驱动芯片为 **GC9503CV**。细长分辨率适合条形 HMI、侧边状态条、竖向信息面板等场景。

规格标识（仓库名）：`3.13-tft-376x960-mipi-gc9503cv`

当前模组版本：**YDP313B003-V1**。电气与外形细节以 [`docs/YDP_313_B003_V1_42c8bc11c7.pdf`](./docs/YDP_313_B003_V1_42c8bc11c7.pdf) 为准。
...
| 资料 | 链接 |
| ---- | ---- |
| 产品规格书（YDP313B003-V1） | [`docs/YDP_313_B003_V1_42c8bc11c7.pdf`](./docs/YDP_313_B003_V1_42c8bc11c7.pdf) |
...
- 使用中如有问题，也可在本仓库 [Issues](https://github.com/osptek/3.13-tft-376x960-mipi-gc9503cv/issues) 中提问
